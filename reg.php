                ...
                <td bgcolor="" valign="top">
                    <center>
                        ...
                        <table width="910" bgcolor="#FFFFFF">
                            <tr>
                                <td align="center"><a href="#"> <img src="image/scool.png" height="30" width="30"> <span
                                                class="reg">  Я -  школьник  </span> </a></td>
                                <td bgcolor="#666666" align="center"><a href="reg1.php"> <img src="image/student.png"
                                                                                              height="30"
                                                                                              width="30"><span
                                                class="reg">  Я - студент </span> </a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
...
FROM chet, klient where idklient=idklientchet and datechet>'$d' ");
                                        ...
                                        <tr>
                                            <td colspan="3" bgcolor="">
                                                <center><br><input type="submit" value="Зарегистрироваться" name="reg"
                                                                   class="button blue"><br>
                                                    </form><br>
                                            </td>
                                        </tr>
                                        <tr>
