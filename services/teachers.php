...
class Teachers
{
    ...
    public function getNameTeachers()
    {
        if ($result = $this->connection->query("SELECT teacher.id, 
                    CONCAT_WS(' ', teacher.sur_name, teacher.name, teacher.father_name) as name 
    ...
    public function getSubjects(): array
    {
        ...
        } elseif ($result = $this->connection->query("SELECT subject.*, 
                    CONCAT_WS(' ', teacher.sur_name, teacher.name, teacher.father_name) as teachers
                    FROM subject
                    LEFT JOIN subject_teacher
                    ON  subject.id = subject_teacher.subject_id 
